      ...
      <div className="w-full max-w-md">
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Sign up in seconds and you'll be ready to go.
          </p>
        </div>
        ...
        <Card className="p-8">
          ...
          <div className="space-y-4 mb-6">
            ...
            >
              ...
              <span className="text-black group-hover:text-white transition-colors duration-200">Continue with Google</span>
            </Button>
            ...
            >
              ...
              <span className="text-black group-hover:text-white transition-colors duration-200">Continue with Apple</span>
            </Button>
          </div>
